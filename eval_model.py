...
# Author: Siqi Zhang
# Date: Aug 31st, 2018
# Description: This is the file for evaluating the model in terms of mAP and precision/recall
# Input: The training image set (45 images)
# Output: Precision recall for bud,flower,fruit. mAP
#----------------------------------------------------------------------------------------------------------------------
SAVE_IMG = True
...
# ----------------------------------------------------------------------------------------------------------------------
# Visualize the detected features on the input image, and compute Precision/Recall
# ----------------------------------------------------------------------------------------------------------------------
